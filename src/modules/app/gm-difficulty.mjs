...
const SYSTEM_KEY_GM_DIFFICULTY_POOL = `${ANARCHY_ID}.${GM_DIFFICULTY_POOLS}`;
export class GMDifficulty {
  ...
  onReady() {
    game.settings.register(ANARCHY_ID, GM_DIFFICULTY_POOLS, {
      scope: "world",
  ...
  loadDifficultySettings() {
    const setting = game.settings.get(ANARCHY_ID, GM_DIFFICULTY_POOLS);
