 ...
 */
export const ANARCHY_ID = 'anarchy';
export const SYSTEM_DESCRIPTION = "Anarchy";
export const SYSTEM_SOCKET = `system.${ANARCHY_ID}`;
export const SYSTEM_SCOPE = ANARCHY_ID;
export const SYSTEM_PATH = `systems/${ANARCHY_ID}`;
export const STYLE_PATH = `${SYSTEM_PATH}/style`;
export const TEMPLATES_PATH = `systems/${ANARCHY_ID}/templates`;
