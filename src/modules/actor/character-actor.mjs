...
import { TEMPLATE, TEMPLATES_PATH } from "../constants.mjs";
...
import { Checkbars, DEFAULT_CHECKBARS } from "../common/checkbars.mjs";
import { RollCelebrity } from "../dialog/roll-celebrity.mjs";
import { MATRIX, Matrix, NO_MATRIX_MONITOR } from "../matrix-helper.mjs";
...
export class CharacterActor extends AnarchyBaseActor {
  ...
  computeEssence() {
    // base essence
    const baseEssence = game.system.anarchy.hacks.baseEssence(this)
  ...
  computeMalusEssence(essence = undefined) {
    return game.system.anarchy.hacks.malusEssence(this, essence ?? this.computeEssence())
  }
