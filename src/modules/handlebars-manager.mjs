...
export class HandlebarsManager {
  ...
  registerBasicHelpers() {
    ...
    Handlebars.registerHelper('add', (...args) => args.reduce((a, b) => a + b))
    Handlebars.registerHelper('multiply', (...args) => args.reduce((a, b) => a * b))
    Handlebars.registerHelper('diff', (v1, v2) => v1 - v2);
    Handlebars.registerHelper('min', (...args) => Math.min(...args));
    Handlebars.registerHelper('max', (...args) => Math.max(...args));
